...
const inputClass = "w-full px-3.5 py-2.5 text-[15px] border border-stone-300 rounded-lg bg-white text-stone-900 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-teal-600 focus:ring-offset-2 focus:border-transparent";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center gap-15 p-6 bg-stone-100 bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,rgba(13,115,119,0.12),transparent),radial-gradient(ellipse_60%_40%_at_100%_100%,rgba(13,115,119,0.06),transparent)]">
      <div className="w-[50%] max-w-md p-8 bg-white rounded-2xl border border-stone-200 shadow-lg shadow-black/5">
      ...
      {/* <div className="w-[50%] max-w- bg-white rounded-2xl border min-h-screen bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,rgba(13,115,119,0.12),transparent),radial-gradient(ellipse_60%_40%_at_100%_100%,rgba(13,115,119,0.06),transparent)]">
        <h2>Images</h2>
      </div> */}
    </div>
  );
