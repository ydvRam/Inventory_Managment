...
export default function AdminPricingPage() {
  ...
  return (
    <div className="max-full mx-auto">
      ...
      <div className="md:flex flex-cols gap-10">
        <section className="max-w-full mb-5 p-5 bg-white border border-stone-200 rounded-xl">
        ...
        <section className="max-w-5xl p-5 bg-white border border-stone-200 rounded-xl">
